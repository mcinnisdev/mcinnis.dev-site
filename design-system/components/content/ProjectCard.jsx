    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 'var(--space-3)', padding: featured ? 'var(--space-6)' : 'var(--space-5)' }}>
        ...
        <h3 style={{ display: 'flex', flexDirection: 'column', gap: 2, fontFamily: 'var(--font-display)', letterSpacing: 'var(--tracking-display)', lineHeight: 'var(--leading-snug)' }}>
          <span style={{ fontSize: featured ? 'var(--text-3xl)' : 'var(--text-2xl)', fontWeight: 'var(--weight-bold)', color: hover ? 'var(--orange-400)' : 'var(--text-display)', transition: 'var(--transition-control)' }}>{name}</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', flexWrap: 'wrap', marginTop: 'auto', paddingTop: 'var(--space-2)' }}>
          ...
          {href && (
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, flexShrink: 0, fontFamily: 'var(--font-mono)', fontSize: 'var(--text-xs)', letterSpacing: 'var(--tracking-wide)', textTransform: 'uppercase', color: hover ? 'var(--orange-400)' : 'var(--text-meta)', transition: 'var(--transition-control)' }}>
